...
public class DiWMS_AutoTest_GUI extends JFrame {
//	private JFrame frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					DiWMS_AutoTest_GUI frame = new DiWMS_AutoTest_GUI();
	...
	public DiWMS_AutoTest_GUI() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				DiWMS_AutoTest_GUI startEngine = new DiWMS_AutoTest_GUI();
